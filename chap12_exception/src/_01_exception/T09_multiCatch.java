 ...
 * 	 : 이떄 catch 첫번째 부터 차례대로 본인의 예외의 클래스인지 확인 후 맞으면 예외처리
...
public class T09_multiCatch {
	...
	public static void main(String[] args) {
		...
		System.out.print("나누기할 정수 2개를 입력하세요 : ");
		...
		try {
			...
			System.out.println("예외 발생");	// Exception은 가장 상위 부모 : 모든 예외는 다 처리
			// 맨 마지막에 써야 함
			System.out.println("워닝워닝 이멀전씨 " + e);
		}
