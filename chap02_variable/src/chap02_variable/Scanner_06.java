...
public class Scanner_06 {
	public static void main(String[] args) {
		...
		boolean student = scan.nextBoolean();	//true 나 false 만 받을 수 있음
		System.out.println("당신의 답은 : " + student);
		
		// 실수형으로 받을 때 nextDouble()
		// 문자열ㅢ 한 문장을 얻어올 때 nextLine() : enter를 칠때까지
		scan.nextLine();
		System.out.print("주소 입력 : ");
		// 24줄의 enter가 들어옴 nextLine()을 중간에 사용할 때는 한번더 써줘서 앞의 enter를 넣어줌
		// 혹은 맨 첫줄에 넣을때는 상관없음
