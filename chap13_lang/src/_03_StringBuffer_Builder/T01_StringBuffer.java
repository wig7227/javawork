 ...
 * 					자주 변경되는 문자열을 사용할 떄, 멀티스레드 사용시
 * 
 * StringBuilder : 추가, 삭제, 수정할 수 있다.
 * 					자주 변경되는 문자열을 사용할 떄, 단일스레드 사용시
 * 					StringBuffer보다 빠르다
 * 
...
public class T01_StringBuffer {
	...
	public static void main(String[] args) {
		...
		// delete()
		sb1.delete(3, 6);
		System.out.println("3~5번까지 삭제한 후 : " + sb1);
		sb1.deleteCharAt(1);
		...
		System.out.println("(index)5번부터 끝까지를 pro대체 : " + sb1);
		System.out.println("sb1의 글자를 거꾸로 : " + sb1.reverse());
		
		// capacity() : StringBuffer의 크기
		//				객체가 생성될떄 기본버퍼의 크기는 16Byte + 문자크기
