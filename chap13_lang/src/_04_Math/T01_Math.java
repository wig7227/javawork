...
public class T01_Math {
	...
	public static void main(String[] args) {
		...
		// 소수점이하 무조건 올림 : ceil()
		System.out.println("123.432의 올림 : " + Math.ceil(123.432));
		System.out.println("-23.3의 올림 : " + Math.ceil(-23.3));
		...
		System.out.println("12.34567을 소수점 2쨰라리까지 : " + Math.round(value2) / (double)100);
		
		// 두 수중 큰수 or 작은수 : max(),min()
		System.out.println("7과 7중 큰수 : " + Math.max(7, 5));
		System.out.println("7과 7중 큰수 : " + Math.min(7, 5));
		...
		System.out.println("25의 제곱근 : " + (int)Math.sqrt(81));
