 ...
 * 1. ArrayList
 *    * 제네릭
 * 		ArrayList<> => 모든 자료형을 받을 수 있도록 만듦
 * 						사용할 때 자료형을 넣어주면 됨
 * 	  * 기본배열 10개 : 10개를 초과하여 넣으면 배수만큼 더 만들어 줌
...
public class T01_ArrayList {
	...
	public static void main(String[] args) {
		...
		list.add(2,"css");
		System.out.println(list.get(2));  // 얻어올떄 : get(index번호) 사용. list[index] -> 안됨
		...
		*/
		/*
		   삭제 : Object remove(index)
		    	 ...
		    	 void clear() : 모두 삭제
		*/	
		System.out.println("사제한 객체 : " + list.remove(2));
